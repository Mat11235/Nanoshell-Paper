...
set output "../img/oGp/map_nly.pdf"
set lmargin screen  0.15
set rmargin screen  0.75
set tmargin screen  0.95
set tmargin screen  0.95
...
unset output
!convert -density 300 "../img/oGp/map_nly.pdf" "../img/oGp/0-map_nly.png"
!mv "../img/oGp/map_nly.pdf" "../img/oGp/pdf/map_nly.pdf"

set output "../img/oGp/map_isa.pdf"
set multiplot
set lmargin screen  0.15
set rmargin screen  0.75
set tmargin screen  0.95
...
unset multiplot
unset output
!convert -density 300 "../img/oGp/map_isa.pdf" "../img/oGp/1-map_isa.png"
!mv "../img/oGp/map_isa.pdf" "../img/oGp/pdf/map_isa.pdf"
...
set output "../img/oGp/map_isk.pdf"
set multiplot
set lmargin screen  0.15
set rmargin screen  0.75
set tmargin screen  0.95
...
unset multiplot
unset output
!convert -density 300 "../img/oGp/map_isk.pdf" "../img/oGp/3-map_isk.png"
!mv "../img/oGp/map_isk.pdf" "../img/oGp/pdf/map_isk.pdf"
...
set output "../img/oGp/map_isak.pdf"
set multiplot
set lmargin screen  0.15
set rmargin screen  0.75
set tmargin screen  0.95
...
unset multiplot
unset output
!convert -density 300 "../img/oGp/map_isak.pdf" "../img/oGp/2-map_isak.png"
!mv "../img/oGp/map_isak.pdf" "../img/oGp/pdf/map_isak.pdf"
