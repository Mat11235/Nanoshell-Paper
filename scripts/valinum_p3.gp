...
plot[omin:omax] "../data/output/ns_intensity_SS.dat" u 1:5 w l lw 2 t "non shifted analytical |p_3|^2", "../data/output/numspec.dat" u 1:3 w p pt 7 t "non shifted numerical |p_3|^2";
