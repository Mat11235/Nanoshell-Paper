...
plot[omin:omax]  "../data/output/oGp/ome_al.dat" u ($1):($4) axis x1y2  w l lw 2 lc rgb "orange" t "Re({/Symbol k})",\
                 ""  u ($1):($5/1000) axis x1y2  w l lw 2 lc rgb "purple" t "Im({/Symbol k})×10^{-3}",\
